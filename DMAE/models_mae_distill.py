...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 distillation_disentangled_target=None, student_reconstruction_target='original_img',
        ...
        print('************* num_patches + 1:')
        print(num_patches + 1)
        print('img_size = '+str(img_size) +', patch_size = '+str(patch_size)+', in_chans = '+str(in_chans)+', embed_dim = '+str(embed_dim))
        """
    ...
    def forward(self, imgs, ids_keep, ids_restore, mask, teacher_prediction, target_sum_weights=None,
        ...
        """
        print('****** debug 4 !')
        print('self.student_reconstruction_target = ' + str(self.student_reconstruction_target))
        assert(False)
        """
